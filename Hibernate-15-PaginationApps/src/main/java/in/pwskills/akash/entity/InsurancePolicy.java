...
@Entity
@NamedQuery(name = "GET_POLICIES_COUNT", query = "SELECT count(*) FROM in.pwskills.akash.entity.InsurancePolicy")
@NamedQuery(name = "GET_ALL_POLICIES", query = "FROM in.pwskills.akash.entity.InsurancePolicy")
