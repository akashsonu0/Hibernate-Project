...
@Entity
@NamedQuery(name = "HQL_TRANSFER_POLICIS", query = 
		 "INSERT INTO in.pwskills.akash.bean.PremiumInsurancePolicy(policyId,policyName,policyType,company,tenure) SELECT i.policyId,i.policyName,i.policyType,i.company,i.tenure FROM in.pwskills.akash.bean.InsurancePolicy AS i WHERE i.tenure>=:min")
