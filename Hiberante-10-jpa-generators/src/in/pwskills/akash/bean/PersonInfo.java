...
public class PersonInfo  implements Serializable{
	...
	@Id
	@TableGenerator(name="gen",table="ID_TAB",initialValue=10,allocationSize=5,
	pkColumnName ="ID_COL",pkColumnValue="PID",
	valueColumnName="ID_VAL")
	
	@GeneratedValue(generator="gen",strategy = GenerationType.TABLE)//identity algorithm :: MySQL
	private Integer id;
